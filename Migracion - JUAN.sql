...
SELECT COMPRA_NRO, COMPRA_CANT, COMPRA_PRECIO
FROM gd_esquema.Maestra
SELECT *
FROM LOS_CAPOS.ITEMS_COMPRAS A
INNER JOIN LOS_CAPOS.COMPRAS B ON A.id_compras = B.id_compras
WHERE compra_nro = 191595
ORDER BY compra_nro

SELECT * 
FROM LOS_CAPOS.COMPRAS 
WHERE id_compras = 19486
